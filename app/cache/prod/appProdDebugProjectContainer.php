...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'FinalProyecto', 'host' => '127.0.0.1', 'port' => 3306, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('C:\\xampp\\htdocs\\Symfony\\src\\UNLP\\Proyecto\\FinalBundle\\Resources\\config\\doctrine' => 'UNLP\\Proyecto\\FinalBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'UNLP\\Proyecto\\FinalBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('FinalProyectoBundle' => 'UNLP\\Proyecto\\FinalBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'e65fa47ce02f49eb33ad7103acee1711e');
    }
    ...
    {
        $this->services['pdo'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=FinalProyecto', 'root', NULL);
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 60, 'gc_maxlifetime' => 3, 'gc_probability' => 3, 'gc_divisor' => 4), $this->get('session.handler.pdo'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Symfony\\src\\Jazzyweb\\AulasMentor\\AlimentosBundle/Resources/views', 'JazzywebAulasMentorAlimentos');
        $instance->addPath('C:\\xampp\\htdocs\\Symfony\\src\\UNLP\\Proyecto\\FinalBundle/Resources/views', 'FinalProyecto');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e65fa47ce02f49eb33ad7103acee1711e');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Symfony/app/../web', true);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FinalProyectoBundle' => 'UNLP\\Proyecto\\FinalBundle\\FinalProyectoBundle',
            ),
            ...
            'locale' => 'en',
            'secret' => 'e65fa47ce02f49eb33ad7103acee1711e',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'e65fa47ce02f49eb33ad7103acee1711e',
